...
const projectsData = [
  {
    id: "gyananjali",
    title: "Gyananjali Platform",
    badge: "Live Demo",
    badgeType: "accent",
    description: "A fully responsive, mobile-first web app with integrated UPI payment gateways, interactive countdown timers, real-time live chat integration, and optimized SEO performance.",
    tags: ["JavaScript", "Node.js", "Express", "UPI API", "Socket.io"],
    liveUrl: "http://gyananjali.online",
    codebase: "",
  },
  {
    id: "spotify",
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="pt-12 pb-16 bg-brand-bg relative overflow-hidden scroll-mt-20">
              ...
              <div className="p-6 flex-grow flex flex-col justify-between">
                <div>
                  <div className="flex justify-between items-start mb-3">
                    ...
                    <span className={`px-2 py-0.5 rounded-sm text-[9px] font-extrabold tracking-widest uppercase ${
                      project.badgeType === "accent"
                        ? "bg-brand-accent/10 border border-brand-accent/30 text-brand-accent"
                        : "bg-brand-border border border-brand-border/40 text-gray-400"
                    }`}>
                      {project.badge}
                    </span>
                  </div>
                ...
                <div className="flex gap-4 items-center">
                  ...
                  {project.liveUrl && project.codebase && (
