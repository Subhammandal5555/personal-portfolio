              ...
              <div className="flex flex-col gap-4 mt-4 font-sans text-sm text-gray-300">
                <div className="flex items-center gap-4 p-4 rounded-lg bg-brand-card/45 border border-brand-border">
                  ...
                  <div>
                    ...
                    <a href="mailto:subhammandal5555@gmail.com" className="text-white hover:text-brand-accent transition-colors duration-200">
                      subhammandal5555@gmail.com
                    </a>
                  </div>
                </div>
            ...
            <div className="mt-8 lg:mt-0">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-12 h-12 rounded-lg bg-brand-card border border-brand-border flex items-center justify-center text-gray-400 hover:text-brand-accent hover:border-brand-accent hover:shadow-[0_0_15px_rgba(135,90,123,0.3)] transition-all duration-300"
                  title="GitHub"
                >
